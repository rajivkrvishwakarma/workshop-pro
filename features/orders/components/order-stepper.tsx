  ...
  return (
    <div className="w-full max-w-7xl mx-auto md:p-4 md:space-y-6 h-full flex flex-col">
      ...
      <div className="md:bg-surface md:border border-outline-variant md:rounded-xl md:p-6 md:shadow-sm min-h-[400px] flex-1 flex flex-col w-full relative">
        ...
        {isSuccess ? (
          <div className="fixed min-w-screen inset-0 z-50 bg-background flex flex-col items-center justify-center text-center px-8 animate-in fade-in duration-500 md:relative md:inset-auto md:flex-1 md:w-full md:px-4">
            ...
            <h2 className="text-xl md:text-3xl font-black text-foreground mb-3 tracking-tight">
              Order Captured!
            </h2>
            ...
            <div className="mt-10 min-w-screen flex flex-col items-center gap-3 w-full max-w-xs">
          ...
          <>
            {currentStep === 0 && (
              <CustomerStep
                ...
                defaultData={orderData.customer}
              />
            )}
            {currentStep === 1 && (
              <ProductsManagerStep
            ...
            {currentStep === 2 && (
              <AttachmentsStep
                ...
                onNext={handleNext}
                onBack={handleBack}
                defaultData={orderData.attachments}
              />
            )}
            {currentStep === 3 && (
              <CommercialStep
                ...
                onNext={handleNext}
                onBack={handleBack}
                defaultData={orderData.commercial}
              />
            )}
          </>
        )}

      ...
      <div className="flex flex-col items-center pt-16 pb-8 sm:hidden relative z-10 w-full px-8">
        <div className="relative mb-5">
          ...
          <div className="relative h-20 w-20 rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/10">
            <Image src="/logo.png" alt="Workshop Pro" width={80} height={80} className="object-cover" />
          </div>
        </div>
        <h1 className="text-4xl font-black text-white tracking-tight leading-none">
          Welcome Back
        </h1>
        <p className="text-blue-300/70 text-sm mt-2 font-medium">Sign in to Workshop Pro</p>
      </div>
          ...
          <div className="hidden sm:flex flex-col items-center mb-8">
            <div className="relative mb-5">
              ...
              <div className="relative h-16 w-16 rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/10">
                <Image src="/logo.png" alt="Workshop Pro" width={64} height={64} className="object-cover" />
              </div>
            </div>
            <h1 className="text-3xl font-black text-white tracking-tight">Welcome Back</h1>
            <p className="text-blue-300/60 text-sm mt-1.5 font-medium">Sign in to Workshop Pro</p>
          </div>
